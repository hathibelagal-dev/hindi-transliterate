function transliterate(text, sanskritMode = false) {
  const words = text.split(" ");
  const result = [];

  for (const word of words) {
    const hunterianWord = _devanagariToHunterian(word, sanskritMode);
...
function _devanagariToHunterian(text, sanskritMode) {
  const casualMap = {
    अ: "a",
    आ: "aa",
    इ: "i",
  ...
  var devanagariMap = sanskritMode ? sanskritMap : casualMap;
